package com.github.zj.dreamly.controller;
...
import com.github.zj.dreamly.model.common.BaseDto;
...
import com.github.zj.dreamly.service.IUserService;
...
import com.github.zj.dreamly.util.AesCipherUtil;
import com.github.zj.dreamly.util.JwtUtil;
import com.github.zj.dreamly.util.UserUtil;
    ...
    public ResponseBean online() {
        ...
        for (String key : keys) {
            if (JedisUtil.exists(key)) {
                ...
                // 设置登录时间
                userDto.setLoginTime(new Date(Long.parseLong((String) Objects.requireNonNull(JedisUtil.getObject(key)))));
